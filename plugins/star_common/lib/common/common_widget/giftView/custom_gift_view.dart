...
class _GifViewState extends State<CustomGiftView>
  ...
  Future<List<ImageInfo>> fetchGif(ImageProvider provider) async {
    ...
    if (provider is NetworkImage) {
      dynamic d = StorageService.to.getString(provider.url);
      ...
      if (d != null) {
        ...
        StorageService.to.setString(provider.url, data);
      }
