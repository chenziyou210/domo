...
class CustomErrorDeal extends ErrorDeal with Toast  {
  void Function()? tokenInvalid;
  CustomErrorDeal({this.tokenInvalid});
  ...
  void tokenError(String msg) {
    ...
    Future.delayed(Duration(seconds: 0)).then((value) => {
      // showToast("tokenError please write code")
      tokenInvalid?.call()
      // (Get.find<MyMineSettingLogic>()).tokenLoginOut(NavKey.navKey.currentContext!)
    });
  }
}
