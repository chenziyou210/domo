...
class HttpConfig {
  ...
  HttpConfig.clone(HttpConfig config,{String? host = null,String port = ""}): this(
      timeOut: config.timeOut,
      connectTimeOut: config.connectTimeOut,
      slaveCloseTime:  config.slaveCloseTime,
      maxSlave: config.maxSlave,
      maxLongRunningSlave: config.maxLongRunningSlave,
      ...
      isDevelop: config.isDevelop,
      enableRedirect: config.enableRedirect,
      refreshUnit : config.refreshUnit,
      errorDeal: config.errorDeal,
  // this.interceptor,
        statusCodeIgnoreRetry: config.statusCodeIgnoreRetry
  );
}